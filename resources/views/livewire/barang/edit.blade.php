            ...
            <div class="card border-0 shadow-lg mb-4" style="background: linear-gradient(135deg, #ffc107 0%, #fd7e14 100%);">
                <div class="card-body p-4 text-white">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <h3 class="fw-bold mb-2">Edit Barang</h3>
                            <p class="mb-0 opacity-75 fs-5">Ubah informasi barang yang ada</p>
                        </div>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-footer bg-light border-top">
                    <div class="d-flex gap-2 justify-content-end">
                        ...
                        <button type="submit" wire:click="update" class="btn btn-warning fw-semibold text-white">
                            <svg class="me-2" width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
